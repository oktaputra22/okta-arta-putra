...
int main()
{
    ...
    int harga,jumlah,total,jumtotal,jumbayar,kembalian,potongan, totalKeseluruhan = 0;
    string input, kode;
    
    awal:
    cout<<"==========          putra store       =========="<<endl;
    cout<<"==== JL. Dukuh Pulu. mambang. tabanan. bali ===="<<endl;
    cout<<"================================================="<<endl;
    cout<<"nama pembeli  :";
    cin >> pembeli;
    ...
    cin>>jumlah;
     ...
     cout << "===================================="<<endl;
      ...
      totalKeseluruhan = totalKeseluruhan + jumtotal;
     cout << " input lagi [Y] untuk ya [T] untuk tidak "<<endl;
     cout << "====================================="<<endl;
     cout << " input lagi [Y/T] : ";
     cin  >> input;
     ...
     if (input == "y" || input == "Y" ){
         goto awal;
            ...
            cout << "==============================="<<endl;
            cout << "nilai total semua barang Rp =  "<<totalKeseluruhan << endl;
        }
